...
| [P0.1 Product Measurement Contract adversarial review R1](methodology/p0-1-product-measurement-contract-adversarial-review.md) | Pre-freeze adversarial review, R1–R30 findings, corrections, residual risks, and human-freeze boundary |
