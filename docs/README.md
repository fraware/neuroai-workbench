...
| [P0.1 Product Measurement Contract adversarial review](methodology/p0-1-product-measurement-contract-adversarial-review.md) | Pre-freeze adversarial review, R1–R40 findings, final consistency audit, residual risks, and human-freeze boundary |
