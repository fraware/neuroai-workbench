...
- Archive / network approvals: #44
- Canonical `AUTHORIZED` / `PUBLISHED` successor: #101 / #41

Wave 2 digests stay `SHADOW_EVALUATION_NOT_CANONICAL`. Completing this procedure does not authorize a canonical successor.
