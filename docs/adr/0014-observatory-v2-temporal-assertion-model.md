...
Proposed under issues #225 and #226. This ADR governs the target observatory representation only. It does not change the v4.2 normative assessment kernel, authorize a v2 public data release, or establish institutional deployment readiness.
