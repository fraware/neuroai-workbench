...
- `review.py` records claimed local review assignments, assignment lineage, statements, disagreements, appeals, and human dispositions without mutating assessments or authenticating identities. Accepted proposals apply only through an ordinary assessment edit.
